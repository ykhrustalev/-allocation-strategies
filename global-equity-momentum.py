...
universe = symbols('SPY', 'EFA', 'AGG', 'BIL')
...
def rebalance(context, data):
    ...
    spy = out.loc[symbol('SPY'), 'momentum']
    efa = out.loc[symbol('EFA'), 'momentum']
    bil = out.loc[symbol('BIL'), 'momentum']
    ...
    context.to_hold[s] = context.share_for_allocation
